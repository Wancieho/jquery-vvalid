...
(function ($, window, document, undefined) {
    ...
    function vValid(options, fields) {
        ...
        this.validation(options, fields);
    }

    $.extend(vValid.prototype, {
        validation: function (options, fields) {
    ...
    function errorsGenerate(element, errors) {
    ...
    function alphaNumericSpecial(value) {
    ...
    function max(value, limit) {
        if (value.length > parseInt(limit)) {
            return this.settings.messages.max + limit;
        }
    }

    function exact(value, limit) {
        if (value.length !== parseInt(limit)) {
    ...
    function match(value, matchedElement) {
